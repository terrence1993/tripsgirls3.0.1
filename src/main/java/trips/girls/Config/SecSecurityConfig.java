...
import trips.girls.google2fa.CustomAuthenticationProvider;
import trips.girls.google2fa.CustomWebAuthenticationDetailsSource;

@Configuration
@ComponentScan(basePackages = {"trips.girls"})
@EnableWebSecurity
